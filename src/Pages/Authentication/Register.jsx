...
import useAxios from "../../Hooks/useAxios"; // Import your axios hook
...
const Register = () => {
  ...
  const handleRegister = async (data) => {
    ...
    try {
      ...
      // Step 2: Save user data to MySQL database
      ...
      navigate("/");
      console.log("User registered and saved to database:", firebaseUser);
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Step 2: Save or verify user in MySQL database
      await axiosInstance.post("/api/verify-user", {
      ...
      // Step 3: Redirect to home page
      navigate("/");
      console.log("Google user saved to database:", firebaseUser);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-base-200 via-base-100 to-base-200 px-4 relative overflow-hidden py-8">
      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex-1 text-center lg:text-left mb-8 lg:mb-0">
          ...
          <p className="text-base-content/70 text-lg mb-8 max-w-md mx-auto lg:mx-0">
            Create an account to enjoy exclusive offers, easy reservations, and a personalized dining experience.
          </p>
          ...
          <div className="space-y-3 max-w-sm mx-auto lg:mx-0">
            {[
              ...
              <div key={index} className="flex items-center gap-3 text-base-content/80">
        ...
        <div className="flex-1 w-full max-w-md">
          <div className="card bg-base-100/80 backdrop-blur-sm shadow-2xl border border-base-300/50 hover:shadow-primary/5 transition-all duration-300 max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit(handleRegister)} className="space-y-4">
                ...
                <div className="form-control">
                  ...
                  {password && password.length > 0 && password.length < 6 && (
                    <p className="text-warning text-xs mt-1">Password should be at least 6 characters</p>
                  )}
                </div>
