...
import { FaUser, FaSignOutAlt, FaUtensils, FaConciergeBell } from "react-icons/fa";
...
const Navbar = () => {
  ...
  const getRoleIcon = () => {
    ...
    if (staffInfo?.role === "waiter") return <FaConciergeBell className="text-sm" />;
    return null;
  };
  ...
  const links = (
    <>
      ...
      <li><NavLink to="/reservations" className={navLinkClass}>Reservations</NavLink></li>
    ...
    <div className="navbar bg-base-100 border-b border-base-300 px-4 sm:px-10 lg:px-20">
      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 border border-base-300 rounded-box z-50 mt-3 w-52 p-2 shadow-lg">
            {links}
          </ul>
        </div>
        <NavLink to="/" className="btn btn-ghost text-2xl font-black tracking-widest uppercase text-primary hover:bg-transparent">
          🔥 Crave
        </NavLink>
      </div>
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-50 mt-3 w-56 p-2 shadow-lg border border-base-300">
              ...
              <li className="menu-title">
                <div className="flex flex-col gap-1">
                  <span className="font-semibold text-sm text-base-content">{staffInfo?.name}</span>
                  <span className={`badge badge-sm ${getRoleBadgeColor()} gap-1 w-fit`}>
                    {getRoleIcon()}
              ...
              <li>
                <button onClick={handleStaffLogout} className="text-error gap-2">
